...
import wang.imallen.blog.imageloader.display.impl.FadeInBitmapDisplayer;
	...
	private static class ImageAdapter extends PagerAdapter {
		...
		ImageAdapter(Context context) {
			...
			options = new DisplayImageOptions.Builder()
                    ...
                    .setDisplayer(new FadeInBitmapDisplayer(300))
                    .build();
		...
		public Object instantiateItem(ViewGroup view, int position) {
			...
			AllenImageLoader.getInstance().displayImage(IMAGE_URLS[position], imageView,
                    options, new SimpleImageLoadingListener()
             {
				@Override
				public void onLoadingStarted(String imageUri, View view) {
					Logger.d(TAG,"onLoadingStarted,imageUri="+imageUri);
				...
				public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
					...
					if(null!=failReason)
					{
						Logger.d(TAG,"onLoadingFailed,failReason:"+failReason.toString());
					}
					String message = null;
				...
				public void onLoadingComplete(String imageUri, View view, Bitmap loadedImage) {
					Logger.d(TAG, "onLoadingComplete,imageUri=" + imageUri);
					spinner.setVisibility(View.GONE);
				}
			});
