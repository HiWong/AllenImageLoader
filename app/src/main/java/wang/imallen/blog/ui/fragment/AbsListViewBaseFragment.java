...
import wang.imallen.blog.imageloader.listener.PauseOnScrollListener;
...
public abstract class AbsListViewBaseFragment extends BaseFragment {
	...
	private void applyScrollListener() {
		listView.setOnScrollListener(new PauseOnScrollListener(AllenImageLoader.getInstance(), pauseOnScroll, pauseOnFling));
	}
}
